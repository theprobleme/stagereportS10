...
\begin{figure}[ht!]
    ...
    \caption{Disques présent sur le noeud \begin{code}\texttt{an-virt-pmx-1}\end{code}}
...
\begin{figure}[ht!]
    ...
    \caption{Ensemble des \gls{OSD} du \gls{cluster} \begin{code}\texttt{an-virt-pmx}\end{code}}
...
\begin{tabular}{|c|c|M{11.5cm}|}
    ...
    Particularité de devoir ajouter un second disque et donc recréer un module Terraform.
    \tabularnewline

...
\addcontentsline{toc}{section}{Engagement de non plagiat}
...
% Sommaire %
\newpage
\section*{\phantomsection Table des matières}
...
\addcontentsline{toc}{section}{Fiche de synthèse}
...
\newpage
\subsection*{Tickets réalisés lors de la période de stage}
\begin{table}[!ht]
    \newcolumntype{M}[1]{>{\raggedright}m{#1}}
    \center
    \begin{adjustbox}{max width=\textwidth}
    ...
    \hline
        Demande & Février & Mars & Avril & Mai & Juin & Juillet & Temps total \\ \hline
        TOTAL & 136,67 & 162,66 & 133,00 & 126,00 & 154,00 & 127,08 & 839,41 \\ \hline
        \begin{code} DATACENTER\end{code} & 83,50 & 154,66 & 64,25 & 14,50 & 12,00 & 0,17 & 329,08 \\ \hline
        Nom de domaine pour page Assistant RGAA & 1,00 &  &  &  &  &  & 1,00 \\ \hline
        Déplacement datacenter 2022 &  &  & 4,00 &  & 7,00 &  & 11,00 \\ \hline
        Réunions internes Datacenter 2022 & 2,33 &  &  &  &  &  & 2,33 \\ \hline
        Installation Ceph sur le cluster de Test Proxmox & 11,00 & 16,00 &  &  &  &  & 27,00 \\ \hline
        Installation Framemo & 3,00 &  &  &  &  &  & 3,00 \\ \hline
        Installation de GLPI & 23,00 & 4,50 &  &  &  &  & 27,50 \\ \hline
        Remplacement du disque & 0,50 &  &  &  &  &  & 0,50 \\ \hline
        Installation de la derniére version & 4,50 &  &  &  &  &  & 4,50 \\ \hline
        Compréhension du fonctionnement de GLPI & 1,00 &  &  &  &  &  & 1,00 \\ \hline
        Installation du plugin OCS-Inventory & 4,67 &  &  &  &  &  & 4,67 \\ \hline
        Ajout GLPI de la base de données OCSInventory et import de l'ancienne base de données & 4,50 &  &  &  &  &  & 4,50 \\ \hline
        Configuration pour l'affectation aux entités & 7,00 & 1,50 &  &  &  &  & 8,50 \\ \hline
        Configuration des éléments é importer &  & 4,00 &  &  &  &  & 4,00 \\ \hline
...
\begin{table}[!ht]
        ...
        \hline
        Demande & Février & Mars & Avril & Mai & Juin & Juillet & Temps total \\ \hline      
        Documentation audit de sécurité &  & 5,00 &  &  &  &  & 5,00 \\ \hline
        Réinstallation cluster Proxmox Angers &  & 8,50 &  &  &  &  & 8,50 \\ \hline
        Installation pour Audit de sécurité &  & 25,67 &  &  &  &  & 25,67 \\ \hline
        Ajout de l'ensemble des salariés &  & 1,50 &  &  &  &  & 1,50 \\ \hline
        Installation PC de télé-travail pour Clélia &  & 2,50 &  &  &  &  & 2,50 \\ \hline
        Mise en place local d'Ansible et reprise des travaux de Raphaél &  & 5,00 &  &  &  &  & 5,00 \\ \hline
        Ajout des machines d'Angers sur OCSInventory via Ansible &  & 7,00 & 7,00 &  &  &  & 14,00 \\ \hline
        Streaming d'un webinaire pour l'URSCOP le 12 mai &  &  &  & 1,50 &  &  & 1,50 \\ \hline
        Ajout des machines de Tours sur OCSInventory via Ansible &  &  & 1,00 &  &  &  & 1,00 \\ \hline
        Ajout des machines de Rennes sur OCSInventory via Ansible &  &  & 4,00 &  &  &  & 4,00 \\ \hline
        Veille Kubernetes &  &  & 11,75 &  &  &  & 11,75 \\ \hline
        Montée de version superset &  &  & 1,50 &  &  &  & 1,50 \\ \hline
        Compréhension et configuration pour relier les DC d'Angers et Tours &  &  & 4,00 &  &  &  & 4,00 \\ \hline
        Installation Zammad sur Tours &  &  &  & 2,00 &  &  & 2,00 \\ \hline
        Mise en place d'une plateforme Peertube et tests streaming &  &  &  & 7,00 &  &  & 7,00 \\ \hline
        Post it pour les JL 2022 &  &  &  &  & 2,00 &  & 2,00 \\ \hline
        Creation Compte mail associes@empreintedigitale.fr &  &  &  &  & 1,00 &  & 1,00 \\ \hline
...
\begin{table}[!ht]
    ...
    \hline
    Demande & Février & Mars & Avril & Mai & Juin & Juillet & Temps total \\ \hline      
    \begin{code}RH\end{code}  & 4,00 &  & 2,00 & 5,00 & 5,00 & 1,50 & 17,50 \\ \hline
    Procédure nouvel arrivant - Axel Liszkowski & 4,00 &  &  &  &  &  & 4,00 \\ \hline
    Procédure nouvel arrivant : Marie ANDRE &  &  & 2,00 &  &  &  & 2,00 \\ \hline
    Présentation des outils et configurations pour Marie André &  &  &  & 3,00 &  &  & 3,00 \\ \hline
    Procédure Arrivé Bertrand Raes &  &  &  & 2,00 &  &  & 2,00 \\ \hline
    Procédure départ Jochen Rousse &  &  &  &  &  & 0,50 & 0,50 \\ \hline
    Arrivée Samuel MASSON &  &  &  &  & 5,00 &  & 5,00 \\ \hline
    Arrivée Rodolphe REMY &  &  &  &  &  & 0,50 & 0,50 \\ \hline
    Procédure nouvel arrivant : Thibault Dequidt &  &  &  &  &  & 0,50 & 0,50 \\ \hline
    Demande & Février & Mars & Avril & Mai & Juin & Juillet & Temps total \\ \hline
    \begin{code}FOURNITURES\end{code} &  &  &  &  &  & 1,00 & 1,00 \\ \hline
    Préparation de la commande pour les arrivé d'aout et septembre &  &  &  &  &  & 1,00 & 1,00 \\ \hline
    \begin{code}AD07\end{code} & 0,50 &  &  &  &  &  & 0,50 \\ \hline
    Nombre de téléchargement & 0,50 &  &  &  &  &  & 0,50 \\ \hline
    \begin{code}AD33\end{code} &  &  &  & 3,00 &  &  & 3,00 \\ \hline
    PAS Département de la gironde &  &  &  & 3,00 &  &  & 3,00 \\ \hline
...
\begin{tabular}{|p{6cm}|c|c|c|c|c|c|c|}
    \hline
    Demande & Février & Mars & Avril & Mai & Juin & Juillet & Temps total \\ \hline  
    \begin{code}Fibat\end{code} &  &  & 0,25 &  &  &  & 0,25 \\ \hline
    Questions Divers &  &  & 0,25 &  &  &  & 0,25 \\ \hline
    \begin{code}Cybersécurité\end{code} & 46,33 & 7,50 & 34,00 & 12,00 & 59,00 & 13,00 & 171,83 \\ \hline
    Analyse état actuel de l'infrastructure & 3,00 &  &  &  &  &  & 3,00 \\ \hline
    POC Site Web monitoring/push & 8,00 &  &  &  &  &  & 8,00 \\ \hline
    Installation OpenVAS & 13,00 &  &  &  &  &  & 13,00 \\ \hline
    Mise à jours du tableau de suivi d'audit & 14,00 &  &  &  &  &  & 14,00 \\ \hline
    POC DeepFence & 2,00 &  &  &  &  &  & 2,00 \\ \hline
    Recherches de solutions d'audit de sécurité & 2,00 &  &  &  &  &  & 2,00 \\ \hline
    Rapport de stage & 3,00 & 5,50 & 1,00 & 1,00 & 13,50 & 10,00 & 34,00 \\ \hline
    Installation Log4j-RCE-Scanner & 1,33 &  &  &  &  &  & 1,33 \\ \hline
    Installation locale avec test sur la machine OCS Inventory &  & 2,00 &  &  &  &  & 2,00 \\ \hline
    Outils d'audit de sécurité automatisée &  &  & 30,00 &  &  &  & 30,00 \\ \hline
    Parcours et recherche d'outils d'audit de sécurité &  &  & 3,00 &  &  &  & 3,00 \\ \hline
    Découverte de l'outil en ligne de commande, installations tests - Automatisation via Ansible de l'installation &  &  &  & 7,00 &  &  & 7,00 \\ \hline
    Création d'une archive .dev é partir des ressources pour l'installation sur les machines Debian dont la version est supérieure é 10 &  &  &  & 4,00 &  &  & 4,00 \\ \hline
    Création d'un role Ansible pour automatiser la récupération de document d'audit et l'application de correctifs &  &  &  &  & 29,00 &  & 29,00 \\ \hline
    Test et corrections &  &  &  &  & 10,00 &  & 10,00 \\ \hline
    Checklist de sécurité basé sur le bilan de l'audit de sécurité &  &  &  &  & 1,50 &  & 1,50 \\ \hline
    Tests divers avec snort &  &  &  &  & 1,00 &  & 1,00 \\ \hline

\end{tabular}
\end{adjustbox}
\caption{Tickets réalisés lors de la période de stage - Partie 4}
\end{table}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{|p{6cm}|c|c|c|c|c|c|c|}
        \hline
        Demande & Février & Mars & Avril & Mai & Juin & Juillet & Temps total \\ \hline 
        Installation d'un Zammad pour Stratosfair &  &  &  &  & 3,00 &  & 3,00 \\ \hline
        Réunion de restitution avec cogent &  &  &  &  & 1,00 &  & 1,00 \\ \hline
        Suivi des travaux de valentin sur l'URSSAF &  &  &  &  &  & 3,00 & 3,00 \\ \hline
        \begin{code}Réunions transverses\end{code} &  &  &  &  &  & 7,00 & 7,00 \\ \hline
        Divers réunions internes (transverses) &  &  &  &  &  & 7,00 & 7,00 \\ \hline
        \begin{code}Groupe de travail\end{code} &  &  &  &  &  & 2,00 & 2,00 \\ \hline
        [Dev] GT Embarquement &  &  &  &  &  & 2,00 & 2,00 \\ \hline
        \begin{code} Marketing et Commercial\end{code} &  &  &  & 1,00 &  &  & 1,00 \\ \hline
        Page webinaire pour le 12 mai &  &  &  & 1,00 &  &  & 1,00 \\ \hline
        \begin{code}Marketing et Commercial - A11Y\end{code} &  &  &  & 1,00 &  &  & 1,00 \\ \hline
        Webinaire Lucie 20 mai &  &  &  & 1,00 &  &  & 1,00 \\ \hline
        \begin{code}Marketing et commercial - RGPD\end{code} &  &  &  &  & 0,50 &  & 0,50 \\ \hline
...
\begin{tabular}{|p{6cm}|c|c|c|c|c|c|c|}
    \hline
    Demande & Février & Mars & Avril & Mai & Juin & Juillet & Temps total \\ \hline  
    \begin{code}Dehon with cyres\end{code}&  &  &  &  & 49,50 & 61,50 & 111,00 \\ \hline
    Installation machines Cogent &  &  &  &  &  & 7,00 & 7,00 \\ \hline
    Déploiement des VMs avec le versionning dans TF &  &  &  &  & 11,00 &  & 11,00 \\ \hline
    Configuration des VMs avec Kubespray en version 1.23.7 de kube &  &  &  &  & 15,00 &  & 15,00 \\ \hline
    Configuration HA du cluster kube (Haproxy en gateway api) &  &  &  &  & 18,50 &  & 18,50 \\ \hline
    Configuration des composants &  &  &  &  & 4,00 & 17,50 & 21,50 \\ \hline
    Création du stockage &  &  &  &  &  & 31,00 & 31,00 \\ \hline
    Install WikiJs &  &  &  &  & 1,00 &  & 1,00 \\ \hline
    Rédaction de la documentation technique du projet &  &  &  &  &  & 6,00 & 6,00 \\ \hline
    \begin{code}Region Normandie\end{code} &  &  &  &  & 10,00 & 5,00 & 15,00 \\ \hline
    Nom du service :  matomo Nom du client : Région Normandie &  &  &  &  & 10,00 & 5,00 & 15,00 \\ \hline
    \begin{code}AICLA\end{code} &  &  &  &  &  & 33,00 & 33,00 \\ \hline
    Install Nextcloud &  &  &  &  &  & 33,00 & 33,00 \\ \hline
    \begin{code}TOTAUX\end{code} & 136,67 & 162,66 & 133,00 & 126,00 & 154,00 & 127,08 & 839,41 \\ \hline 
\end{tabular}
\end{adjustbox}
\caption{Tickets réalisés lors de la période de stage - Partie 6}
\end{table}
